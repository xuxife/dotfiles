...
complete -c copilot -l dynamic-retrieval -r -d 'Enable or disable embeddings-based dynamic retrieval per category and persist the choice (category: skills). Repeatable, e.g. --dynamic-retrieval skills=off'
complete -c copilot -l max-iterations -r -d 'Set the maximum model-call iterations allowed for each response'
complete -c copilot -l max-credits -r -d 'Set the maximum AI Credits allowed for each response'
